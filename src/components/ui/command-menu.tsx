  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-20 z-40 hidden md:flex items-center gap-2 rounded-full border border-border bg-[#12151E] px-4 py-2 text-xs text-foreground/50 hover:text-white hover:border-white/20 transition-all duration-300 cursor-pointer shadow-lg"
      >
        ...
        {isOpen && (
          <div className="fixed inset-0 z-9999 flex items-start justify-center pt-[15vh] px-4">
            ...
            <motion.div
              ...
              ref={containerRef}
              className="relative w-full max-w-lg overflow-hidden rounded-xl border border-border bg-[#12151E] shadow-[0_32px_64px_rgba(0,0,0,0.6)] flex flex-col"
            >
              {/* Search Header */}
