          ...
          <div className="space-y-20">
            {TIMELINE_PROCESS.map((step, idx) => {
              ...
              return (
                ...
                >
                  <div className="relative flex flex-col md:flex-row items-start md:justify-between glass-card bg-[#12151E] border border-[rgba(255,255,255,0.12)] shadow-xl p-6 md:p-8 rounded-2xl">
