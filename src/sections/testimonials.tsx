...
export const Testimonials: React.FC = () => {
  return (
    <section className="relative py-20 border-t border-border overflow-hidden bg-background">
      <div className="absolute inset-0 bg-grid-pattern opacity-10 -z-10" />
      
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Card 
          glowColor="purple"
          className="p-8 md:p-12 text-center flex flex-col items-center gap-6 border-white/5 shadow-2xl relative overflow-hidden"
        >
          ...
          {/* Subtext info */}
          <div className="text-[10px] font-mono text-foreground/30 uppercase tracking-widest pt-4 border-t border-white/5 w-full max-w-xs">
