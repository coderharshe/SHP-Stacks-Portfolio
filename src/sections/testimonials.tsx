    ...
    <section className="relative py-20 border-t border-border overflow-hidden bg-transparent">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="text-[10px] font-mono uppercase tracking-widest pt-4 w-full max-w-xs" style={{ color: 'var(--text-disabled)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
